...
export const ProfileCompletion = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(
        "https://book-review-app-3.onrender.com/users/completion",
        profileData
      );
  ...
  return (
    <div className="bg-white w-full h-[70vh] rounded-xl shadow-md flex flex-col items-center p-10">
      ...
      {errMsg && <p className="bg-red-200 rounded-md p-1 m-1">{errMsg}</p>}
      ...
      <button
        ...
        className="text-white text-lg bg-succ py-2 px-4 rounded-lg font-semibold m-2"
      >
        Next
      </button>
    </div>
